...
local goplements_plugin = {
  "maxandron/goplements.nvim",
  ft = "go",
  opts = {
    -- Default settings are fine, but you can customize:
    -- prefix = {
...
local runner_plugin = {
  ...
  keys = {
    ...
    { "<leader>rt", function() require("runner-nvim").toggle() end, desc = "Toggle terminal" },
  },
}
